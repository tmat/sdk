...
{
    [Fact]
    public async Task IncludeDirective_UpdateIncludedFile()
    {
    ...
    [Fact]
    public async Task IncludeDirective_UpdateDirective()
    {
        var testAsset = TestAssets.CreateTestAsset("FBA");
        ...
        App.Process.ClearOutput();
        UpdateSourceFile(entryPointFilePath, src => src.Replace("// uncomment //", ""));
